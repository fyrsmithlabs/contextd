...
**Re-indexing is efficient:**
- Idempotent - re-indexing updates existing collection, no duplicates
- Incremental - only changed files are re-processed
- Fast - initial index may take 30-60s for large repos, subsequent re-indexes typically <5s
