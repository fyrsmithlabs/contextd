...
ContextD uses a systematic error code system for diagnosing issues. When you encounter an error message with a code like `CTX-XXX-YYY`, refer to the **[Error Codes Reference](./api/error-codes.md)** for:
...
**Quick lookup:** Search for your error code in [error-codes.md](./api/error-codes.md) to find specific guidance.
...
- [Error Codes Reference](./api/error-codes.md) - Systematic error code lookup and resolution
