...
3. **MCP Protocol**: stdio transport → HTTP with SSE streaming
...
**0.9.0-rc-1 MCP Transport** (HTTP with SSE):
```json
{
  "mcpServers": {
    "contextd": {
...
- SSE streaming provides real-time progress for long operations
